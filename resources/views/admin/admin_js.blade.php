       ...
       $(document).on('click', '.view-admin', function() {
            ...
            $.ajax({
                ...
                success: function(admin) {
                    $('#view-name').text(admin.name);
                    $('#view-email').text(admin.email);
                    $('#view-year_level').text(admin.year_level);
                    $('#view-course_id').text(admin.course_id);
                    $('#view-department_id').text(admin.department_id);
                    $('#view-barangay').text(admin.barangay);
                    $('#view-municipal').text(admin.municipal);
                    $('#view-province').text(admin.province);
                    $('#view-contact').text(admin.contact);
                    $('#view-password').text(admin.password);
                    $('#view-user-type').text(admin.user_type);
          ...
          //show admin value in update form
          $(document).on('click', '.update_admin_form',function(){
            let id = $(this).data('id');
