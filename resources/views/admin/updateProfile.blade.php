...
@section('content')
    <h5 class="mb-4"><i class="fas fa-user-circle"></i> Edit Profile</h5>
    <div class="bg-white shadow-md p-6 rounded-lg">
        <form method="POST" action="{{ route('admin.updateProfile', $admin->id) }}">
            @csrf
            @method('PUT')
            ...
            <!-- add other profile information fields here as needed -->
