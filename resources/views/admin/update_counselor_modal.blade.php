...
<!-- Modal -->
<div class="modal fade" id="updateCounselorModal" tabindex="-1" aria-labelledby="updateCounselorModalLabel" aria-hidden="true">
    <form action="/admin/add-user" method="post" id="updateCounselorForm">
        @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary update_counselor">Update</button>
            </div>
        </div>
    </div>
</form>
