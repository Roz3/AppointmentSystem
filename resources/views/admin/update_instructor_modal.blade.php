...
<!-- Modal -->
<div class="modal fade" id="updateInstructorModal" tabindex="-1" aria-labelledby="updateInstructorModalLabel" aria-hidden="true">
    <form action="/admin/add-user" method="post" id="updateInstructorForm">
        @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary update_instructor">Update</button>
            </div>
        </div>
    </div>
</form>
