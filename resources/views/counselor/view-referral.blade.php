...
<table class="table">
            <tbody>
                ...
                <tr>
                    ...
                    <td> {{ App\Models\User::find($referral->student_id)->email }}</td>
                </tr>

                <tr>
                    <td class="font-bold">REFERRED BY:</td>
                    <td> {{ App\Models\User::find($referral->instructor_id)->name }}</td>
                </tr>

                <tr>
                    <td class="font-bold">EMAIL:</td>
                    <td> {{ App\Models\User::find($referral->instructor_id)->email }}</td>
                </tr>
                ...
                <tr>   
                    ...
                    <td class="{{ $referral->status === 'done' ? 'text-green-500 font-bold' : '' }}"> {{ $referral->status }}</td>
                </tr>

        </tbody>
    </table>
    <a href="{{ route('counselor.records', ['type' => 'referrals']) }}" class="inline-block py-2 px-4 bg-gray-300 hover:bg-gray-400 rounded-lg text-black font-bold no-underline">Back to Records</a>
