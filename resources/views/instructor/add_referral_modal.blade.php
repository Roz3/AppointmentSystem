...
<div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
  <form action="/instructor/add-referral" method="POST" id="addReferralForm">
        @csrf
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                 <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">Referral Form</h5>
                    ...
                    <div class="modal-body">
                        ...
                        @if(Auth::user()->user_type == 'instructor')
                            <label for="instructor_name">Name:</label>
                                <input type="text" class="form-control" name="instructor_name" id="instructor_name" value="{{ Auth::user()->name }}" readonly>
                    ...
                    <button type="button" class="btn btn-primary add_referral">Submit</button>
                </div>
            </div>
        </div>
  </form>
