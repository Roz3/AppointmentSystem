...
<div class="flex justify-between items-center mb-3">
      ...
      <form class="flex items-center mr-4" method="GET" action="{{ route('instructorSearch') }}">
      ...
      <a href="" class="btn btn-primary my-4" data-bs-toggle="modal" data-bs-target="#addModal">
        <i class="fas fa-plus mr-2"></i>Create Referral
      </a>
  ...
  <thead>
    ...
    @if(!$referral->isDeletedByInstructor())
        <tr class="hover:bg-gray-200">
            ...
            <a href="{{ route('instructor.view_referral', ['id' => $referral->id]) }}" class="inline-block py-2 px-4 bg-blue-600 hover:bg-blue-700 rounded-lg text-white font-bold">View</a>
            </td>
        </tr>
    @endif
@endforeach
...
@include('/instructor/add_referral_modal')

@include('/instructor/update_referral_modal')
@include('/instructor/referral_js')
