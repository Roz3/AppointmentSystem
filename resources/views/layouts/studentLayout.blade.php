...
<head>
    ...
    <link href="{{ asset('assets/css/callslip.css') }}" rel="stylesheet">
...
<header class="navbar">
  <nav class="navbar-nav navbar-right">
    ...
    <li><a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        <span class="icon"><i class="fas fa-sign-out-alt me-2"></i></span>
                        <span class="item">{{ __('Logout') }}</span>
                    </a>
    ...
    <div id="main-content" class="main-content bg-gray-200" style="min-height: 100vh;">
