  ...
  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <p style="text-indent: 20em;"><span id="view-callslip-created"></span></p>
                    ...
                    <div class="content">
                        <p>Dear <span id="view-student-name">{{ App\Models\User::find($callslip->student_id)->name }},</p>

                        <p style="text-indent: 4em;">Please see your guidance counselor at BISU Guidance Office on <strong><span id="view-callslip-date"></strong> at <strong><span id="view-callslip-time"></strong>.</p>
